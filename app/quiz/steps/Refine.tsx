...
// TODO(Task 10): full implementation — climate/culture/intensity refinement step
...
export default function Refine({ onNext, onBack }: RefineProps) {
  return (
    <div className="relo-placeholder">
      ...
      >
        <div className="relo-placeholder__icon">🎛️</div>
        <h2 className="relo-placeholder__title">Fine-tune your vibe</h2>
        <p className="relo-placeholder__sub">
          Climate, culture, intensity sliders. Coming together…
        </p>
        <p className="relo-placeholder__note">Refine step — Task 10</p>
